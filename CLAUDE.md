...
|---|---|---|---|
| 1 | Mood | 249999475 | UX, UI, Product Design, Neo-Brutalism, Case Study, Mobile |
| 2 | Nutri Track — All-in-one Fitness & Nutrition App | 236877329 | UX, UI, Research, Case Study, Mobile, Fitness |
| 3 | Conecta Eventos App | 159766653 | App Design, Mobile, UX/UI |
| 4 | Smart Home | 114344793 | UI, UX, Interface |
| 5 | Paisagismo Digital | 109345211 | UI, UX, Interface |
| 6 | Virtual MED | 109343675 | UI, UX, Telemedicine |
| 7 | Fashi-on | 109341327 | UI, UX, Ecommerce, Mobile |
